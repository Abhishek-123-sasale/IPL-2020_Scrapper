...
export default function initStyles(_ref) {
  ...
  function getStyle(fontWeight, align, alignVertical, format, wrap, color, backgroundColor, borderColor, borderStyle, leftBorderColor, leftBorderStyle, rightBorderColor, rightBorderStyle, topBorderColor, topBorderStyle, bottomBorderColor, bottomBorderStyle) {
    // Custom borders aren't supported.
    var border = undefined; // Look for an existing style.

    var fontKey = "".concat(fontWeight || '-', ":").concat(color || '-');
